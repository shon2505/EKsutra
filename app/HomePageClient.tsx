...
export default function HomePageClient() {
  ...
  return (
    <div style={{ minHeight: "calc(100vh - 52px)" }}>
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "0.25rem" }}>
              <Image src={PrimaryLogo} alt="EkSutra Logo" style={{ height: 150, width: "auto" }} />
            </div>
            Verify once.
            <br />
            Reuse securely.
      ...
      {/* ── 4-Step Visual ── */}
      <section style={{ padding: "4rem 1.5rem", background: "var(--bg-base)" }}>
            ...
            {[
              {
                step: "1",
                word: "VERIFY",
                icon: <Shield size={28} style={{ color: "var(--accent-gold)" }} />,
                title: "Verify Once",
              ...
              },
              {
                step: "3",
                word: "REUSE",
                icon: <RefreshCw size={28} style={{ color: "var(--accent-gold)" }} />,
      ...
      {/* ── Demo Journey ── */}
      <section
        style={{ padding: "4rem 1.5rem", background: "var(--bg-base)", borderTop: "1px solid var(--border-subtle)" }}
      >
          ...
          >
            {[
              ...
              >
                ...
                <div
                  style={{ fontSize: "0.8125rem", color: "var(--text-secondary)", marginBottom: "1rem" }}
                >
